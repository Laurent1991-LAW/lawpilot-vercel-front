  ...
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" label-width="80px">
      <el-row>
        ...
        <el-col :span="8" :offset="2">
          <el-form-item label="Sign-in ID" prop="userName">
    ...
    <el-table v-loading="loading" :row-key="getRowKey" @row-click="clickRow" ref="table" @selection-change="handleSelectionChange" :data="roles.slice((pageNum-1)*pageSize,pageNum*pageSize)">
      <el-table-column label="Number" type="index" align="center">
        <template slot-scope="scope">
          <span>{{(pageNum - 1) * pageSize + scope.$index + 1}}</span>
        </template>
      </el-table-column>
      <el-table-column type="selection" :reserve-selection="true" width="55"></el-table-column>
      <el-table-column label="Role Number" align="center" prop="roleId" />
      <el-table-column label="Role Name " align="center" prop="roleName" />
      <el-table-column label="Role ID" align="center" prop="roleKey" />
