<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" label-width="150px">
      <el-form-item label="Login Location" prop="ipaddr">
        <el-input
    ...
    <el-table
      ...
      style="width: 100%;"
    >
      <el-table-column label="Number"  width="80"  type="index" align="center">
      ...
      <el-table-column label="Department Name "  width="100"   align="center" prop="deptName" />
...
export default {
  ...
  methods: {
    ...
    handleForceLogout(row) {
      this.$modal.confirm('Confirm to force logout "' + row.userName + '"?').then(function() {
        return forceLogout(row.tokenId);
      }).then(() => {
        this.getList();
        this.$modal.msgSuccess("force logout succeed");
      }).catch(() => {});
    }
  }
};
